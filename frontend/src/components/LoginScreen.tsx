...
import { Coffee, Lock, LogIn, Mail, ShieldCheck, Sparkles, Utensils } from "lucide-react";
      ...
      <section className="relative z-10 grid min-h-screen grid-cols-1 lg:grid-cols-[55%_45%]">
        <div className="flex flex-col justify-center px-6 py-12 sm:px-10 lg:px-16 xl:px-24">
          <div className="max-w-2xl">
            <div className="mb-14 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-[#6F4E37] to-[#3E2723] shadow-2xl shadow-[#6F4E37]/20">
                <Coffee className="h-6 w-6 text-[#F8E7C6]" />
              </div>
              <span className="font-display text-base font-black uppercase tracking-[0.24em] text-[#3E2723]">
                Cafe POS
              </span>
            </div>
            ...
            <div className="mt-12 max-w-lg rounded-[2rem] border border-white/70 bg-white/45 p-5 shadow-[0_24px_70px_rgba(111,78,55,0.12)] backdrop-blur-xl">
              <div className="flex items-center gap-4">
                <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-3xl bg-[#3E2723] text-[#F8E7C6] shadow-xl shadow-[#3E2723]/15">
        ...
        <div className="flex items-center justify-center px-6 pb-12 sm:px-10 lg:px-12 lg:py-12">
          <div className="w-full max-w-[490px] rounded-[2rem] border border-white/80 bg-white/75 p-6 shadow-[0_32px_90px_rgba(62,39,35,0.18)] backdrop-blur-2xl sm:p-8">
            <div className="mb-8">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F5EFE6] text-[#6F4E37]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                ...
                {loading ? "Authenticating..." : "Access Cafe POS"}
              </button>
            </form>
          </div>
        </div>
