export const APP_NAME = "Cafe POS";
export const AUTH_TOKEN_KEY = "cafe_pos_token";
export const LEGACY_AUTH_TOKEN_KEYS: string[] = [];
export const DEFAULT_UPI_VPA = "cafepos@ybl";
